...
# Wall reactions the engine may arm. The evaluator's PUT_WALL_BOUNCE_CALL
# setup is deliberately absent: GEX_WALL_BOUNCE was retired on replay evidence
...
def _gex_wall_candidate(
    ...
    strategy_name = _GEX_WALL_STRATEGY_BY_SETUP.get(str(evaluation.get("setup_type")))
