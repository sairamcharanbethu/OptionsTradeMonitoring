            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-lg bg-zinc-950/65 p-3">
                  ...
                  <div className="mt-1 break-all font-mono text-2xs text-zinc-600">{option.ticker || option.local_symbol || `SPY ${side}`}</div>
                </div>
                <div className="rounded-lg bg-zinc-950/65 p-3">
                ...
                <div className="rounded-lg bg-zinc-950/65 p-3">
                  <div className="text-2xs text-zinc-500">Protected limit ceiling</div>
                  <div className="mt-1 font-mono text-sm font-semibold text-zinc-100">{money(plannedLimit)}</div>
                </div>
                <div className="rounded-lg bg-zinc-950/65 p-3">
                  <div className="text-2xs text-zinc-500">Latest estimated debit</div>
                ...
                <div className="col-span-2 rounded-lg bg-zinc-950/65 p-3">
                  <div className="text-2xs text-zinc-500">Strategy protection</div>
