export type BundledEconomicEvent = {
  id: string;
  name: string;
  source: 'BLS' | 'BEA' | 'Census' | 'Federal Reserve' | 'ISM';
  scheduledAt: string;
  impact?: 'BLOCKING' | 'INFORMATIONAL';
};

// Verified against the official 2026 BLS, BEA, Census, Federal Reserve, and ISM
...
export const WALL_REACTION_BUNDLED_EVENTS: BundledEconomicEvent[] = [
  ...
  { id: 'census-trade-2026-08-04', name: 'U.S. Trade Balance', source: 'Census', scheduledAt: '2026-08-04T12:30:00.000Z', impact: 'INFORMATIONAL' },
  { id: 'bls-jolts-2026-08-04', name: 'Job Openings and Labor Turnover Survey', source: 'BLS', scheduledAt: '2026-08-04T14:00:00.000Z' },
  { id: 'census-factory-orders-2026-08-04', name: 'Factory Orders', source: 'Census', scheduledAt: '2026-08-04T14:00:00.000Z', impact: 'INFORMATIONAL' },
  ...
  { id: 'bls-jolts-2026-09-01', name: 'Job Openings and Labor Turnover Survey', source: 'BLS', scheduledAt: '2026-09-01T14:00:00.000Z' },
  { id: 'census-factory-orders-2026-09-02', name: 'Factory Orders', source: 'Census', scheduledAt: '2026-09-02T14:00:00.000Z', impact: 'INFORMATIONAL' },
  { id: 'ism-services-2026-09-03', name: 'ISM Services PMI', source: 'ISM', scheduledAt: '2026-09-03T14:00:00.000Z' },
  { id: 'census-trade-2026-09-03', name: 'U.S. Trade Balance', source: 'Census', scheduledAt: '2026-09-03T12:30:00.000Z', impact: 'INFORMATIONAL' },
  ...
  { id: 'bls-jolts-2026-09-29', name: 'Job Openings and Labor Turnover Survey', source: 'BLS', scheduledAt: '2026-09-29T14:00:00.000Z' },
  ...
  { id: 'census-factory-orders-2026-10-02', name: 'Factory Orders', source: 'Census', scheduledAt: '2026-10-02T14:00:00.000Z', impact: 'INFORMATIONAL' },
  ...
  { id: 'census-trade-2026-10-06', name: 'U.S. Trade Balance', source: 'Census', scheduledAt: '2026-10-06T12:30:00.000Z', impact: 'INFORMATIONAL' },
  ...
  { id: 'bls-jolts-2026-11-03', name: 'Job Openings and Labor Turnover Survey', source: 'BLS', scheduledAt: '2026-11-03T15:00:00.000Z' },
  { id: 'census-factory-orders-2026-11-03', name: 'Factory Orders', source: 'Census', scheduledAt: '2026-11-03T15:00:00.000Z', impact: 'INFORMATIONAL' },
  { id: 'ism-services-2026-11-04', name: 'ISM Services PMI', source: 'ISM', scheduledAt: '2026-11-04T15:00:00.000Z' },
  { id: 'census-trade-2026-11-04', name: 'U.S. Trade Balance', source: 'Census', scheduledAt: '2026-11-04T13:30:00.000Z', impact: 'INFORMATIONAL' },
  ...
  { id: 'bls-jolts-2026-12-01', name: 'Job Openings and Labor Turnover Survey', source: 'BLS', scheduledAt: '2026-12-01T15:00:00.000Z' },
  { id: 'ism-services-2026-12-03', name: 'ISM Services PMI', source: 'ISM', scheduledAt: '2026-12-03T15:00:00.000Z' },
  { id: 'census-factory-orders-2026-12-03', name: 'Factory Orders', source: 'Census', scheduledAt: '2026-12-03T15:00:00.000Z', impact: 'INFORMATIONAL' },
  { id: 'bls-employment-2026-12-04', name: 'Employment Situation (NFP)', source: 'BLS', scheduledAt: '2026-12-04T13:30:00.000Z' },
  { id: 'census-trade-2026-12-08', name: 'U.S. Trade Balance', source: 'Census', scheduledAt: '2026-12-08T13:30:00.000Z', impact: 'INFORMATIONAL' },
